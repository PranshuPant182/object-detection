...
const ObjectDetection = () => {
        ...
        try {
          const inputTensor = tf.tidy(() =>
            tf.browser.fromPixels(video)
              .resizeBilinear([640, 640]) // Fixed: Uncommented and ensured proper resize
              .div(255.0)
              .expandDims(0)
          );
  ...
  const videoConstraints = { 
    facingMode,
    width: 640,  // Optional: Force specific video dimensions
    height: 640  // Optional: Force specific video dimensions
  };
